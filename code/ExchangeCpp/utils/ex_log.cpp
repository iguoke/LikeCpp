/*************************************************************************
	> File Name: ex_log.cpp
	> Author: hello-futures
	> Mail: 717047832@qq.com 
	> Created Time: 2018年06月26日 星期二 17时04分05秒
 ************************************************************************/

#include "ex_log.h"

int    ex_logger::debug_level   = 1;
string ex_logger::debug_log_file = "./log.txt";
int    ex_logger::debug_log_file_enable = 0;
FILE  *ex_logger::log_fp = NULL;



//-----------------------------------------------
void ex_logger::write_log( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
void ex_logger::write_log_clean( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
//---------------------
void ex_logger::open_logfp_if_not_opened() {
...
//---------------------
void ex_logger::set_debug_level( int level ) 
{
    debug_level = level;
}

//--------------------
void ex_logger::set_debug_logfile( string &pDebug_log_file ) 
{
    debug_log_file = pDebug_log_file;
}

//--------------------
void ex_logger::enable_logfile( int pDebug_log_file_enable ) 
{
